...
<p align="center">
  <img src="./assets/header.jpg" alt="Pixel art night landscape" height="250">
</p>
...
A local Solana transaction rebuilder I wrote to recover an airdrop from a broken sponsored claim flow. It deserializes the captured transaction, removes the dead sponsor path, rewrites the fee and ATA payers, then simulates and sends it.
